...
export default async function NuevaVotacionPortalPage({
  searchParams,
}: {
  ...
  const basePath = "/portal/votaciones";
  ...
  return (
    <div className="mx-auto max-w-lg">
      <Card>
        ...
        <CardContent>
          <form
            action={createVotacionAction.bind(null, membership.comunidadId, basePath)}
